...
# --- ДОБАВИТЬ ЭТОТ БЛОК КОНСТАНТ В НАЧАЛО ФАЙЛА ---

# --- КОНСТАНТЫ ВРЕМЕНИ ДЛЯ ВЫБОРОВ (timedelta) ---
# Набор кандидатов идет 4 часа
CANDIDACY_DURATION = timedelta(hours=4) 

# Голосование идет 8 часов
VOTING_DURATION = timedelta(hours=8) 

# Пауза между выборами (например, 7 дней)
ELECTION_COOLDOWN = timedelta(days=7)
